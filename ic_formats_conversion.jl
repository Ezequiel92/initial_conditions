...
begin
    const out_file = "./ic_low"
    const SIM_COSMO = false
end;

# ╔═╡ 6647922f-bcc9-4438-a454-d8dba7a2d103
# Read the IC in human readable format
#
# Velocity: km/s
# Mass:     10^9 Msun
# Length:   kpc
...
# Write IC fila in the GADGET binary format 
# (SnapFormat=2 in GADGET and ICFormat=2 in AREPO)
#
